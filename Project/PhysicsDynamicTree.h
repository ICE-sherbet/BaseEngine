...
struct b2TreeNode {
  [[nodiscard]] bool IsLeaf() const noexcept { return child1 == kNullNode; }
...
class b2DynamicTree {
 public:
  ...
  b2DynamicTree() {
    ...
    m_nodes[m_nodeCapacity - 1].next = kNullNode;
 ...
 private:
  int32_t AllocateNode() {
    ...
    m_nodes[nodeId].parent = kNullNode;
    m_nodes[nodeId].child1 = kNullNode;
    m_nodes[nodeId].child2 = kNullNode;
