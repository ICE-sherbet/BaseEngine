...
base_engine::physics::PhysicsShape* base_engine::physics::b2CircleShape::Clone(PhysicsBlockAllocator* allocator) const
{
...
base_engine::physics::int32_t base_engine::physics::b2CircleShape::GetChildCount() const
{ return 1; }

bool base_engine::physics::b2CircleShape::TestPoint(const PhysicsTransform& transform, const PVec2& p) const
{
...
bool base_engine::physics::b2CircleShape::RayCast(PhysicsRayCastOutput* output, const PhysicsRayCastInput& input,
    const PhysicsTransform& transform, int32_t childIndex) const
{
...
void base_engine::physics::b2CircleShape::ComputeAABB(PhysicsAABB* aabb, const PhysicsTransform& transform,
