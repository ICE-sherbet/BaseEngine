...
class RenderMof final : public IBaseEngineRender {
 ...
 public:
  ...
  void AddTexture(ITexturePtr texture, const Matrix44& wMat, const Rect& uv,
                  const Color& color, const Vector3& pivot) override;
  ...
  ITexturePtr GetTargetTexture() override;
  void Next() override;
