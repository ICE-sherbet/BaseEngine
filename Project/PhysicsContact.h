...
class PhysicsContact {
 public:
  ...
  virtual void Evaluate(b2Manifold* manifold, const PhysicsTransform& xfA,
 ...
 protected:
  ...
  static void AddType(b2ContactCreateFcn* createFcn,
                      b2ContactDestroyFcn* destroyFcn, PhysicsShape::Type typeA,
  ...
  static b2ContactRegister s_registers[ee::ElementCount<PhysicsShape::Type>()]
